  ...
  return (
    <div className="min-h-screen bg-background">
      <header className="sticky top-0 z-30 border-transparent bg-transparent text-white lg:border-b lg:border-[#cccccc] lg:bg-[#17214c]">
        ...
        <nav className="flex items-center justify-between gap-3 bg-[#2f6fed] pb-0 pl-4 pr-2 pt-4 lg:hidden">
      ...
      <div className="flex bg-[#2f6fed] lg:bg-transparent">
        ...
        <main className="min-w-0 flex-1 rounded-t-[16px] bg-background px-4 pb-24 pt-4 lg:rounded-none lg:px-6 lg:pb-4">
          {title || action ? (
            <div
